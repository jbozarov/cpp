...
of this song, Polycarpus inserts a certain number of words "WUB" before the first word of the song (the number may be 
...
function songDecoder(song){
   return song.split('WUB').filter(val => val !== '').join(' ')
}
